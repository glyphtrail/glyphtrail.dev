...
<header class="nav">
  <div class="container nav-inner">
    ...
    <a class="btn btn-ghost nav-cta" href={GITHUB} target="_blank" rel="me noopener">
  ...
  <section class="hero">
    ...
    <div class="container hero-inner">
      ...
      <div class="hero-cta">
        ...
        <a class="btn btn-ghost" href={GITHUB} target="_blank" rel="me noopener">
          View on GitHub
        </a>
      </div>
...
<span class="c-dim">  MCP server on stdio · query · impact · endpoints</span></code
  ...
  <section class="section">
    <div class="container cta" use:reveal>
      ...
      <div class="hero-cta">
        <a class="btn btn-primary" href={GITHUB} target="_blank" rel="me noopener">
          Get glyphtrail
        </a>
